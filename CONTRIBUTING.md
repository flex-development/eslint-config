...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/eslint-config
   cd eslint-config
   ```
...
Source code is located in [`lib`](lib) directory.
...
```sh
https://github.com/flex-development/eslint-config/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/eslint-config/discussions/new?category=q-a
